...
const source = fs.readFileSync(path.join(__dirname, '..', 'js', 'games5-7-rewards.js'), 'utf8');

test('phần thưởng trong hộp hoàn thành Game 5–7 khai báo live region đầy đủ trước khi chèn', () => {
...
test('thông báo phần thưởng dự phòng Game 5–7 khai báo live region đầy đủ trước khi chèn', () => {
