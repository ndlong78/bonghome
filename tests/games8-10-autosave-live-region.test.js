...
const source = fs.readFileSync(path.join(__dirname, '..', 'js', 'games8-10-autosave.js'), 'utf8');

test('thông báo auto-save Game 8-10 khai báo live region đầy đủ trước khi chèn', () => {
