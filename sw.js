...
const PHIEN_BAN = "bonghome-v19-fruit-theme";
const DANH_SACH_LUU = [
  "./", "./index.html",
  ...
  "./content/games/game1.json", "./content/themes/animals/game1.json", "./content/themes/fruits/game1.json", "./content/themes/index.json",
