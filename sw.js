...
const PHIEN_BAN = "bonghome-v23-game1-rewards";
const DANH_SACH_LUU = [
  "./", "./index.html",
  ...
  "./js/storage.js", "./js/themes.js", "./js/theme-picker.js", "./js/progress.js", "./js/rewards.js", "./js/game1-rewards.js", "./js/game1-theme-progress.js", "./js/game1-content.js", "./js/daily-journey.js",
  "./content/games/game1.json", "./content/themes/animals/game1.json", "./content/themes/fruits/game1.json", "./content/themes/school/game1.json", "./content/themes/index.json", "./content/daily/index.json", "./content/rewards/catalog.json",
