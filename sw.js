...
const PHIEN_BAN = "bonghome-v22-rewards-foundation";
const DANH_SACH_LUU = [
  "./", "./index.html",
  ...
  "./js/storage.js", "./js/themes.js", "./js/theme-picker.js", "./js/progress.js", "./js/rewards.js", "./js/game1-theme-progress.js", "./js/game1-content.js", "./js/daily-journey.js",
